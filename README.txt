...
1. In WooCommerce, go to **WooCommerce > Orders**.
2. Select the order you want to complete. The order displays.
3. Select the **Delivery Date** field. A calendar tool displays.
4. Select a delivery date. ( **Note:** If the date is too far in the future, you will be notified of actions to modify the date to be within the acceptable range. )
5. Select **Completed** from the **Status** drop-down. The customer's application status changes to Pending Delivery and Snap funds your merchant account.
