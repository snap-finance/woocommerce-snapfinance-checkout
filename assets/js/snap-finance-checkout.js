jQuery(document).ready(function () {
    ...
    function change_snap_finace_setting() {
        ...
        if (value == 'live') {
            jQuery('#woocommerce_snap_finance_snap_finance_client_sandbox_id').attr('required', false).parents('tr').hide();
            jQuery('#woocommerce_snap_finance_snap_finance_client_sandbox_secret').attr('required', false).parents('tr').hide();
            jQuery('#woocommerce_snap_finance_snap_finance_client_live_id').attr('required', true).parents('tr').show();
            jQuery('#woocommerce_snap_finance_snap_finance_client_live_secret').attr('required', true).parents('tr').show();
        } else {
            jQuery('#woocommerce_snap_finance_snap_finance_client_live_id').attr('required', false).parents('tr').hide();
            jQuery('#woocommerce_snap_finance_snap_finance_client_live_secret').attr('required', false).parents('tr').hide();
            jQuery('#woocommerce_snap_finance_snap_finance_client_sandbox_id').attr('required', true).parents('tr').show();
            jQuery('#woocommerce_snap_finance_snap_finance_client_sandbox_secret').attr('required', true).parents('tr').show();
        }
    }
